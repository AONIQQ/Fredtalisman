...
// Reusing the ContactForm component from home2/page.tsx for consistency
// If this component definition moves to a shared location, update the import path.
const ContactForm = () => (
...
export default function Call2() {
  return (
    <div className="min-h-screen bg-navy text-white">
      ...
      <section className="bg-navy-light py-2 px-2 text-center flex flex-col items-center space-y-1 sm:space-y-2 md:space-y-3 border-b border-gold/20 shadow-lg">

        {/* H1 removed - Title is now handled in Navigation.tsx */}

        {/* New Section Heading Added Below */}
        <h3 className="text-lg sm:text-xl font-serif font-bold text-white pt-1 pb-1 text-center">
          Why you should book a relationship saving no cost discovery call with Fred Talisman, MFT
        </h3>
        {/* End New Section Heading */}

        <h2 className="text-2xl sm:text-3xl md:text-4xl font-serif font-bold text-gold leading-tight mt-0.5 mb-0.5">
          Is Your Relationship on the Brink?
        </h2>

        <p className="text-sm sm:text-base md:text-lg max-w-lg md:max-w-xl mx-auto text-white/80 mb-0.5 px-1 leading-relaxed">
          I'm a licensed marriage & family therapist. For over 25 years I've shown thousands of clients how to save their relationship, keep their family together & how to make the relationship work for both of them, even when only 1 person was willing to get my help & even if there was cheating or years of fighting & disrespect.
        </p>

        <Link href="/success-stories" className="text-xs sm:text-base md:text-lg text-gold hover:text-gold-light transition-colors underline font-semibold mb-1 md:mb-1.5 relative group">
          read about some of my clients successes with situations probably far worse than yours
          <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-gold group-hover:w-full transition-all duration-300"></span>
        </Link>

        <p className="text-sm sm:text-base md:text-xl max-w-lg md:max-w-xl mx-auto text-white/90 mb-0.5 px-1 font-semibold">
          Every one of those thousands of clients whose relationship I helped to save had only 1 thing in common
        </p>
        <p className="text-xs sm:text-sm md:text-lg max-w-lg md:max-w-xl mx-auto text-white/80 mb-0.5 px-1">
          Every one of the clients I've helped to save their relationship had one thing in common. They all had that initial no cost relationship saving discovery call with me to find out if I could help them.
        </p>

        {/* Call-to-Action Block - Increased text sizes */}
        <div className="flex flex-col gap-1 md:gap-2 w-full max-w-md sm:max-w-lg md:max-w-xl mx-auto pt-0.5 pb-1">
          {/* Increased text size */}
          <a 
            href="tel:+13104293658" 
            className="inline-block bg-gold hover:bg-gold-light text-navy font-bold py-2 px-4 rounded-full transition-colors text-base sm:text-lg md:text-xl text-center shadow-md hover:shadow-lg transform hover:-translate-y-0.5 transition-all"
          >
            Call, text or whatsApp me at +1 310 429-3658
          </a>
          <p className="text-center text-white/80 text-sm md:text-base">OR</p>
          {/* Increased text size */}
          <Link
            href="/calendlybooking"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-block bg-gold hover:bg-gold-light text-navy font-bold py-1 px-2.5 rounded-full transition-colors text-sm sm:text-base md:text-xl text-center whitespace-nowrap shadow-md hover:shadow-lg transform hover:-translate-y-0.5 transition-all"
          >
            schedule a no-cost relationship saving discovery call with me
          </Link>
        </div>

        {/* Increased base text size for this block */}
        <div className="pt-0.5 pb-0 text-center text-xs sm:text-base md:text-lg space-x-1 md:space-x-1.5">
            {/* Reduced text size */}
            <span className="text-white/90">Want to know why I'm so effective in saving & fixing relationships & what I do differently than any other help that you've ever gotten?</span>
            {/* Increased text size */}
            <Link href="/about" className="text-gold hover:text-gold-light transition-colors underline text-sm font-semibold relative group">
              About Fred
              <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-gold group-hover:w-full transition-all duration-300"></span>
            </Link>
         </div>

         {/* Reduced padding, spacing, text sizes */}
         <div className="pt-0.5 pb-0.5 space-y-0.5 max-w-lg md:max-w-xl mx-auto text-center">
             {/* Increased text size */}
             <p className="text-sm sm:text-base md:text-lg text-white/90 font-semibold">Fearful getting help for your relationship can make things worse?</p>
             {/* Increased text size */}
             <p className="text-xs sm:text-sm md:text-lg text-white/80">That was Nicole & Jake's experience before they found me.</p>
             {/* Increased text size */}
             <Link href="#nicole-jake-testimonial" className="text-gold hover:text-gold-light transition-colors underline text-sm sm:text-base md:text-xl font-semibold block relative group">
                Here's their story: "Saved us after last counselor told us we shouldn't be together"
                <span className="absolute -bottom-1 left-1/4 right-1/4 w-1/2 h-0.5 bg-gold group-hover:left-0 group-hover:right-0 group-hover:w-full transition-all duration-300"></span>
             </Link>
         </div>

         {/* Increased base text size for this block */}
         <div className="pt-0.5 pb-1 space-y-0.5 text-sm sm:text-base md:text-lg text-white/90 font-semibold max-w-lg md:max-w-xl mx-auto">
             <p className="border-l-2 border-gold/40 pl-2 py-0.5 leading-snug">You've probably experienced or heard of people that went to couples counseling and it either made things worse or contributed to their relationship ending.</p>
             <p className="border-l-2 border-gold/40 pl-2 py-0.5 leading-snug">I'm not a relationship ender. I'm a relationship saver.</p>
             <p className="border-l-2 border-gold/40 pl-2 py-0.5 leading-snug">I'm Pro-marriage. Pro-relationship. Pro-family.</p>
         </div>
      </section>
      ...
      <main className="container mx-auto px-4 py-12 space-y-16">
        ...
        <section className="flex flex-col md:flex-row items-center gap-6 md:gap-8 bg-navy-light p-6 rounded-lg shadow-lg border border-white/5">
          <div className="flex-shrink-0">
            <Image
              src="/Fred1.jpg" // Assuming same image path
              width={150}
              height={120}
              alt="Fred Talisman MFT"
              className="rounded-lg shadow-md w-[120px] h-auto md:w-[150px] border-2 border-gold/30"
            />
          </div>
          <div className="text-center md:text-left space-y-3">
            ...
            <h3 className="text-xl font-serif font-bold text-gold pt-2 flex items-center">
              <span className="w-6 h-0.5 bg-gold mr-2 hidden md:block"></span>
              One of the Top Marriage Counselors In the Country
            </h3>
            <blockquote className="border-l-4 border-gold pl-4 italic text-white/80 bg-navy-dark/30 py-3 px-2 rounded-r-lg">
             ...
             <Link href="/about" className="text-gold hover:text-gold-light transition-colors underline inline-flex items-center gap-1 pt-2 group">
                Learn more about Fred <span className="text-white/70 group-hover:translate-x-1 transition-transform">→</span>
             </Link>
          </div>
        </section>

        {/* CTA Block */}
        <section className="text-center space-y-3 sm:space-y-0 flex flex-col sm:flex-row sm:items-center sm:justify-center gap-3 sm:gap-4">
          <a 
            href="tel:+13104293658" 
            className="inline-block bg-gold hover:bg-gold-light text-navy font-bold py-2 px-4 rounded-full transition-colors text-lg sm:text-xl text-center shadow-md hover:shadow-lg transform hover:-translate-y-0.5 transition-all"
          >
            Call, text or whatsApp me at +1 310 429-3658
          </a>
          <span className="hidden sm:inline text-lg sm:text-xl text-white/80">or</span>
           <Link
             href="/calendlybooking"
             target="_blank"
             rel="noopener noreferrer"
             className="inline-block bg-gold hover:bg-gold-light text-navy font-bold py-3 px-6 rounded-full transition-colors text-lg sm:text-xl text-center max-w-xs sm:max-w-none mx-auto sm:mx-0 shadow-md hover:shadow-lg transform hover:-translate-y-0.5 transition-all"
           >
             schedule a no-cost relationship saving discovery call with me
           </Link>
        </section>
        ...
        <section className="bg-navy-light p-8 rounded-lg shadow-lg border border-white/10 hover:border-gold/20 transition-colors">
          <div className="relative">
            ...
            {/* Removed the "Read more success stories" link here as it wasn't in the provided copy for this section */}
          </div>
        </section>
        ...
        <section className="bg-navy-light p-8 rounded-lg shadow-lg border border-white/10 hover:border-gold/20 transition-colors">
           <div className="relative">
            <span className="absolute -top-3 -left-3 text-gold/20 text-6xl font-serif">"</span>
            <h3 id="nicole-jake-testimonial" className="text-3xl font-serif font-bold mb-4 text-gold scroll-mt-20 flex items-center"> 
              <span className="w-6 h-0.5 bg-gold mr-2 hidden md:block"></span>
            ...
            {/* Assuming Nicole & Jake wrote this, added attribution for consistency, remove if incorrect */}
            <div className="flex items-center mb-4">
              <div className="h-px w-12 bg-gold/50 mr-4"></div>
            ...
            <Link
              ...
              className="text-gold hover:text-gold-light transition-colors underline inline-flex items-center gap-2 group"
            >
        ...
        <section className="text-center space-y-3 sm:space-y-0 flex flex-col sm:flex-row sm:items-center sm:justify-center gap-3 sm:gap-4">
          <a 
            ...
            className="inline-block bg-gold hover:bg-gold-light text-navy font-bold py-2 px-4 rounded-full transition-colors text-lg sm:text-xl text-center shadow-md hover:shadow-lg transform hover:-translate-y-0.5 transition-all"
          >
            Call, text or whatsApp me now at +1 310 429-3658
          </a>
          <span className="hidden sm:inline text-lg sm:text-xl text-white/80">or</span>
           <Link
              href="/calendlybooking"
        ...
        <section className="space-y-6 bg-navy-light p-8 rounded-lg border border-white/5 shadow-lg">
           ...
           <div className="text-lg sm:text-xl space-y-4 text-white/90 leading-relaxed">
            ...
            {/* Adjusted years based on user copy for this page */}
            <div className="bg-navy-dark/30 p-4 rounded-lg border-l-2 border-gold">
              <p>
            ...
            <p className="italic text-center text-gold/90 text-xl">
            ...
            <p className="font-medium">All marriage counselors and relationship coaches have their biases.</p>
            <p>
        ...
        <section className="space-y-6 bg-navy-light p-8 rounded-lg border border-white/5 shadow-lg">
           ...
           <div className="text-lg sm:text-xl space-y-4 text-white/90 leading-relaxed">
            ...
            {/* Adjusted years based on user copy */}
            ...
            <p>
             ...
             {/* Using the specific different phone number and links from this section of the copy */}
             <div className="flex flex-col gap-4 sm:flex-row sm:gap-6 sm:justify-center pt-4">
               <a
                 href="tel:+13103214658" // Specific phone number from copy
               ...
               >
                Call or text or whatsApp me: +1 310 321 4658
               </a>
               <Link
                href="/calendlybooking" // Updated to internal booking page
                target="_blank"
                rel="noopener noreferrer"
                className="inline-block bg-gold hover:bg-gold-light text-navy font-bold py-3 px-8 rounded-full transition-colors text-lg sm:text-xl text-center shadow-md hover:shadow-lg transform hover:-translate-y-0.5 transition-all"
               >
        ...
        {/* Issues List Section */}
         <section className="space-y-6 bg-navy-light p-8 rounded-lg border border-white/5 shadow-lg">
           ...
           <div className="bg-navy-dark/30 p-8 rounded-lg shadow-lg border border-white/10">
             <div className="flex flex-wrap gap-3 justify-center">
               {[
                 ...
                 // Removed "Happy couple embracing", "Happy couple together" as they seem like image placeholders?
               ].map((issue, index) => (
                 <span
                   key={index}
         ...
         {/* CTA Block - Using specific phone number from copy */}
        <section className="text-center py-10">
            <a 
              href="tel:+13103214658" 
              className="inline-block bg-gold hover:bg-gold-light text-navy font-bold py-4 px-8 rounded-full transition-colors text-xl sm:text-2xl text-center shadow-md hover:shadow-lg transform hover:-translate-y-0.5 transition-all"
            >
              Call, text or What'sApp me now at +1-310-321-4658
            </a>
        </section>
