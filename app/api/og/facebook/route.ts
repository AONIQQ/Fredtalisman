...
export async function GET(request: NextRequest) {
  try {
    ...
    // Process the image for Facebook's preferred dimensions
    ...
    return new NextResponse(processedImage, {
      headers: {
        ...
        'Pragma': 'no-cache',
        'Expires': '0',
        'Content-Disposition': 'inline; filename="fred-talisman.jpg"',
      },
    });
  } catch (error) {
    console.error('Error serving Facebook OG image:', error);
